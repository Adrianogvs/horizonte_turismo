...
def main_app():
    """
    Lógica principal da aplicação (depois que o usuário está autenticado).
    """
    ...
    with aba_principal:
        ...
        with row5[2]:
            ...
            st.number_input("Valor Combustível", value=computed_valor_combustivel, format="%.2f",
                            key="valor_combustivel", disabled=True)
...
def main():
    """
    Inicia a lógica de autenticação (usuário/senha) e, se ok, carrega a aplicação.
    """
